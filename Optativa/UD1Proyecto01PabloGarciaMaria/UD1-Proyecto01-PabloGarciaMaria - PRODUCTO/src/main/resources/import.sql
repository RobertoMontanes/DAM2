INSERT INTO usuarios (nombre, email, username, password, activo, fecha_creacion) VALUES ('Carlos Pérez', 'carlos.perez@example.com', 'cperez', 'password123', true, '2025-11-02');
INSERT INTO usuarios (nombre, email, username, password, activo, fecha_creacion) VALUES ('María López', 'maria.lopez@example.com', 'mlopez', 'maria2025', true, '2025-11-02');
INSERT INTO usuarios (nombre, email, username, password, activo, fecha_creacion) VALUES ('Juan Rodríguez', 'juan.rodriguez@example.com', 'jrodriguez', 'juanpass', false, '2025-11-02');
INSERT INTO usuarios (nombre, email, username, password, activo, fecha_creacion) VALUES ('Laura Gómez', 'laura.gomez@example.com', 'lgomez', 'laura321', true, '2025-11-02');
INSERT INTO usuarios (nombre, email, username, password, activo, fecha_creacion) VALUES ('Andrés Torres', 'andres.torres@example.com', 'atorres', 'andrespass', false, '2025-11-02');
INSERT INTO usuarios (nombre, email, username, password, activo, fecha_creacion) VALUES ('Sofía Ramírez', 'sofia.ramirez@example.com', 'sramirez', 'sof2025', true, '2025-11-02');
INSERT INTO usuarios (nombre, email, username, password, activo, fecha_creacion) VALUES ('Diego Martínez', 'diego.martinez@example.com', 'dmartinez', 'diegopass', true, '2025-11-02');
INSERT INTO usuarios (nombre, email, username, password, activo, fecha_creacion) VALUES ('Valentina Ruiz', 'valentina.ruiz@example.com', 'vruiz', 'valen321', false, '2025-11-02');
INSERT INTO usuarios (nombre, email, username, password, activo, fecha_creacion) VALUES ('Fernando Castillo', 'fernando.castillo@example.com', 'fcastillo', 'ferpass', true, '2025-11-02');
INSERT INTO usuarios (nombre, email, username, password, activo, fecha_creacion) VALUES ('Camila Herrera', 'camila.herrera@example.com', 'cherrera', 'camila2025', true, '2025-11-02');
INSERT INTO usuarios (nombre, email, username, password, activo, fecha_creacion) VALUES ('Ricardo Díaz', 'ricardo.diaz@example.com', 'rdiaz', 'ricardopass', false, '2025-11-02');
INSERT INTO usuarios (nombre, email, username, password, activo, fecha_creacion) VALUES ('Lucía Vega', 'lucia.vega@example.com', 'lvega', 'luciapass', true, '2025-11-02');
INSERT INTO usuarios (nombre, email, username, password, activo, fecha_creacion) VALUES ('Mateo Morales', 'mateo.morales@example.com', 'mmorales', 'mateo2025', true, '2025-11-02');
INSERT INTO usuarios (nombre, email, username, password, activo, fecha_creacion) VALUES ('Paula Navarro', 'paula.navarro@example.com', 'pnavarro', 'paulapass', false, '2025-11-02');
INSERT INTO usuarios (nombre, email, username, password, activo, fecha_creacion) VALUES ('Javier Soto', 'javier.soto@example.com', 'jsoto', 'javi321', true, '2025-11-02');
INSERT INTO usuarios (nombre, email, username, password, activo, fecha_creacion) VALUES ('Natalia Cruz', 'natalia.cruz@example.com', 'ncruz', 'naty2025', true, '2025-11-02');
INSERT INTO usuarios (nombre, email, username, password, activo, fecha_creacion) VALUES ('Hugo Vargas', 'hugo.vargas@example.com', 'hvargas', 'hugopass', false, '2025-11-02');
INSERT INTO usuarios (nombre, email, username, password, activo, fecha_creacion) VALUES ('Elena Rojas', 'elena.rojas@example.com', 'erojas', 'elenapass', true, '2025-11-02');
INSERT INTO usuarios (nombre, email, username, password, activo, fecha_creacion) VALUES ('Gabriel Flores', 'gabriel.flores@example.com', 'gflores', 'gab2025', true, '2025-11-02');
INSERT INTO usuarios (nombre, email, username, password, activo, fecha_creacion) VALUES ('Daniela Campos', 'daniela.campos@example.com', 'dcampos', 'danipass', false, '2025-11-02');
...
INSERT INTO producto (nombre, categoria_producto, peso, cantidad) VALUES ('Smartphone Galaxy X20', 0, 0.18, 120);
INSERT INTO producto (nombre, categoria_producto, peso, cantidad) VALUES ('Laptop ProBook 15"', 0, 1.8, 75);
INSERT INTO producto (nombre, categoria_producto, peso, cantidad) VALUES ('Auriculares Inalámbricos AirBeat', 0, 0.05, 200);
INSERT INTO producto (nombre, categoria_producto, peso, cantidad) VALUES ('Camiseta Deportiva DryFit', 1, 0.25, 340);
INSERT INTO producto (nombre, categoria_producto, peso, cantidad) VALUES ('Pantalón Jeans Classic', 1, 0.6, 180);
INSERT INTO producto (nombre, categoria_producto, peso, cantidad) VALUES ('Zapatillas Running SprintX', 4, 0.9, 150);
INSERT INTO producto (nombre, categoria_producto, peso, cantidad) VALUES ('Sartén Antiadherente 28cm', 3, 1.2, 95);
INSERT INTO producto (nombre, categoria_producto, peso, cantidad) VALUES ('Batidora de Mano MixPro', 3, 1.0, 80);
INSERT INTO producto (nombre, categoria_producto, peso, cantidad) VALUES ('Cafetera Espresso Compacta', 3, 2.4, 60);
INSERT INTO producto (nombre, categoria_producto, peso, cantidad) VALUES ('Escritorio Madera Natural', 3, 18.0, 25);
INSERT INTO producto (nombre, categoria_producto, peso, cantidad) VALUES ('Silla Ergonómica OfficePro', 3, 12.5, 40);
INSERT INTO producto (nombre, categoria_producto, peso, cantidad) VALUES ('Lámpara LED Moderna', 3, 0.8, 130);
INSERT INTO producto (nombre, categoria_producto, peso, cantidad) VALUES ('Colchón Ortopédico Queen', 3, 28.0, 15);
INSERT INTO producto (nombre, categoria_producto, peso, cantidad) VALUES ('Bolso de Cuero Urbano', 1, 0.9, 90);
INSERT INTO producto (nombre, categoria_producto, peso, cantidad) VALUES ('Reloj Inteligente FitBand 5', 0, 0.07, 110);
INSERT INTO producto (nombre, categoria_producto, peso, cantidad) VALUES ('Bicicleta Montaña TrailMax', 4, 14.5, 20);
INSERT INTO producto (nombre, categoria_producto, peso, cantidad) VALUES ('Balón de Fútbol Pro', 4, 0.45, 85);
INSERT INTO producto (nombre, categoria_producto, peso, cantidad) VALUES ('Juego de Toallas Deluxe', 3, 1.1, 150);
INSERT INTO producto (nombre, categoria_producto, peso, cantidad) VALUES ('Perfume Eau de Parfum 100ml', 6, 0.4, 220);
INSERT INTO producto (nombre, categoria_producto, peso, cantidad) VALUES ('Tablet MediaTab 10"', 0, 0.5, 70);
