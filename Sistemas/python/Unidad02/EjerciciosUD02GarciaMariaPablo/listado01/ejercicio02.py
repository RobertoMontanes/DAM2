...
print()
print("## MODIFICAR CON TROCEO ##")
print("Tambien podemos modificar varios elementos a la vez usando el troceo, por ejemplo listaString[2:4] = ['NuevoElemento1', 'NuevoElemento2'] modificara los elementos en las "+
    "posiciones 2 y 3 de la lista.")
listaString[2:4] = ["NuevoElemento1", "NuevoElemento2"]
print("La lista despues de modificar los elementos en las posiciones 2 y 3 es:", listaString)

print("Tambien podemos usar el troceo para insertar un elemento donde antes habia varios, por ejemplo listaString[2:4] = ['ElementoInsertado'] insertara 'ElementoInsertado' en la posicion 2 y eliminara los elementos en las "+
    "posiciones 3 y 4.")
listaString[2:4] = ["ElementoInsertado"]
print("La lista despues de insertar un elemento en la posicion 2 es:", listaString)
